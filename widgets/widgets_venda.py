...
def create_widgets_vendas(self):
    ...
    lblnumvenda = tk.Label(self.cabecalho, text="Núm. Venda:", font=('Calibri', 12, 'bold'), bg='#D8EAF7', fg='black', anchor='w')
    lblnumvenda.place(relx=0.1, rely=0.1, width=100, height=20)
    ...
    self.txtclicpf.place(relx=0.3, rely=0.2, width=100, height=20)
    ...
    lblcodprod.place(relx=0.1, rely=0.1, width=100, height=20)
    ...
    self.btnincluir.place(relx=0.3, rely=0.6, width=100, height=30)
    ...
    self.lblvlrunit.place(relx=0.5, rely=0.3, width=100, height=20)

    self.txtvlrunit = tk.Entry(self.produtos)
    self.txtvlrunit.place(relx=0.7, rely=0.3, width=100, height=20)

    lblvalor = tk.Label(self.produtos, text="Valor:", font=('Calibri', 12, 'bold'), bg='#D8EAF7', fg='black', anchor='w')
    lblvalor.place(relx=0.1, rely=0.4, width=100, height=20)

    self.txtvalor = tk.Entry(self.produtos)
    self.txtvalor.place(relx=0.3, rely=0.4, width=100, height=20)
    ...
    self.txt_total.place(relx=0.9, rely=0.6, width=150, height=40)
    ...
    btnlimpar.place(relx=0.5, rely=0.4, width=100, height=20)
    ...
    btnexcluir.place(relx=0.6, rely=0.6, width=100, height=30)
