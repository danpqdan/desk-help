...
class ClienteTreeview:
    ...
    def criar_treeview_produto(self):
        ...
        self.tree.heading("#1", text="cpf", command=lambda: self.ordenar_coluna("#1", False))
        self.tree.column("#1", width=100, anchor='c')

        self.tree.heading("#2", text="nome", command=lambda:self.ordenar_coluna("#2", False))
        self.tree.column("#2", width=200, anchor='w')

        self.tree.heading("#3", text="telefone", command=lambda:self.ordenar_coluna("#3", False))
        self.tree.column("#3", width=80, anchor='c')

        self.tree.heading("#4", text="email", command=lambda: self.ordenar_coluna("#4", False))
